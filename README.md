...
To run the frontend locally and verify the integration:
...
2.  **Configure Environment**:
    ...
    ```env
    NEXT_PUBLIC_KALA_MONEY_ADDRESS=0xAF53484b277e9b7e9Fb224D2e534ee9beB68B7BA
    NEXT_PUBLIC_RPC_URL=your_sepolia_rpc
    ```
